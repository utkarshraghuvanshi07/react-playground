...
//       <h1 className='italic text-2xl font-bold'>hello</h1>
//       <h1 className='text-[100px]'>hey i am real h1</h1>
//     </div>
//   )
// }
...
const App = () => {
  ...
  const deleteProduct = (id)=>{
    console.log("hey i m delete function "+ id);
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-3 p-2">
        {
        products.map((elem)=><ProductsCard product={elem} del={deleteProduct} key={elem.id} />)
        }
      </div>
